...
for layer in layers:
    for axe in axes:
        ...
        NNwithcenter_pulls =  path + f"NNwithcenter_{layer}_{axe}_pulls.png"
        NNwithgeneric_pulls =  path + f"NNwithgeneric_{layer}_{axe}_pulls.png"
        
 
        images_try = [NNwithcenter, NNwithgeneric, NNwithcenter_pulls, NNwithgeneric_pulls]
        images = [] 
